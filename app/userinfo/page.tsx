...
function identifyBank(cardNumber: string): string {
  ...
  const bankRules: { [key: string]: string } = {
    ...
    '527414': '兴业银行',
    '528931': '兴业银行',
    // '552599': '兴业银行',   // 与交通银行等重复，已移除以避免对象重复键
    // '356879': '兴业银行',   // 与中信银行等重复，已移除以避免对象重复键
    '622901': '兴业银行',
    '622902': '兴业银行',
    '622922': '兴业银行',
    ...
    '622158': '平安银行',
    '622159': '平安银行', 
    // '356885': '平安银行',   // 与中信银行等重复，已移除以避免对象重复键
    // '356886': '平安银行',   // 与中信银行等重复，已移除以避免对象重复键
    // '356887': '平安银行',   // 与中信银行等重复，已移除以避免对象重复键
    // '356888': '平安银行',   // 与中信银行等重复，已移除以避免对象重复键
    // '356889': '平安银行',   // 与中信银行等重复，已移除以避免对象重复键
    // '356890': '平安银行',   // 与中信银行等重复，已移除以避免对象重复键
    // 广发银行
    '622568': '广发银行', 
    '622569': '广发银行', 
    '622570': '广发银行', 
